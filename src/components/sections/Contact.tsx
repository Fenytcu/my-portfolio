...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const shouldFail = !formData.message.trim() || formData.message.toLowerCase().includes("error");
  ...
  return (
    <section id="contact" className="w-full bg-[#F9FAFB] pt-[40px] lg:pt-[120px] pb-5 lg:pb-[50px] flex flex-col items-center">
      <div className="max-w-[1440px] w-full px-6 lg:px-[120px] flex flex-col lg:flex-row gap-16 lg:gap-[98px] relative mb-[50px]">
        ...
        <div className="lg:w-[540px] flex flex-col justify-start">
          ...
          <div className="flex gap-[20px] w-[466px] h-[142px]">
             <div className="w-[142px] h-[142px] rounded-[16px] overflow-hidden shadow-md bg-gray-200">
                <Image src="/assets/Portfolio-Image1.png" alt="Project 1" width={142} height={142} className="object-cover w-full h-full" />
             </div>
             <div className="w-[142px] h-[142px] rounded-[16px] overflow-hidden shadow-md bg-gray-200">
                <Image src="/assets/Portfolio-Image2.png" alt="Project 2" width={142} height={142} className="object-cover w-full h-full" />
             </div>
             <div className="w-[142px] h-[142px] rounded-[16px] overflow-hidden shadow-md bg-gray-200">
                <Image src="/assets/Portfolio-Image3.png" alt="Project 3" width={142} height={142} className="object-cover w-full h-full" />
             </div>
          </div>
        </div>
        ...
        <div className="lg:w-[612px] shrink-0 relative mt-20 lg:mt-0">
          ...
          <div className="absolute top-[-120px] left-1/2 -translate-x-1/2 z-10">
            ...
            >
               <Image src="/assets/contact.png" alt="Let's Talk" width={180} height={180} className="object-contain" />
            </motion.div>
          </div>
          ...
          >
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div className="space-y-2">
                <label className="text-[14px] font-bold font-montserrat text-[#0A0D12]">Name</label>
                <input 
                  type="text" 
                  name="name"
                  value={formData.name}
              ...
              <div className="space-y-2">
                <label className="text-[14px] font-bold font-montserrat text-[#0A0D12]">Email</label>
                <input 
                  type="email" 
                  name="email"
              ...
              <div className="space-y-2">
                <label className="text-[14px] font-bold font-montserrat text-[#0A0D12]">Message</label>
                <textarea 
                  name="message"
